...
const PrivacyPolicy = ({ displayMode }) => {
  useEffect(() => {
    ...
    <div className="max-w-none">
      <div className="text-gray-800 dark:text-gray-200 dim:text-gray-200 gold:text-gray-800 blue:text-gray-800 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-sm">We collect minimal information necessary for service operation.</p>
          <p className="text-sm">Data is used solely to provide and improve our services.</p>
          <p className="text-sm">Contact: synthara.company@gmail.com</p>
        </div>
      </div>
    </div>
  );
