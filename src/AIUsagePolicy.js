...
const AIUsagePolicy = ({ displayMode }) => {
  useEffect(() => {
    ...
    <div className="max-w-none">
      <div className="text-gray-800 dark:text-gray-200 dim:text-gray-200 gold:text-gray-800 blue:text-gray-800 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-sm">Our AI features include image, audio, and video analysis.</p>
          <p className="text-sm">We prioritize transparency, accountability, and privacy.</p>
